...
![AppVersion: 5.26.1.10080](https://img.shields.io/badge/AppVersion-5.26.1.10080-informational?style=flat)
...
[here](https://github.com/hydazz/charts/issues/new?assignees=hydazz&labels=bug&template=bug_report.yaml&name=radarr&version=0.2.1)**
...
| image.tag | string | `"5.26.1.10080"` | Image tag |
