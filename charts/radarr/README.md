...
![AppVersion: 5.27.0.10101](https://img.shields.io/badge/AppVersion-5.27.0.10101-informational?style=flat)
...
[here](https://github.com/hydazz/charts/issues/new?assignees=hydazz&labels=bug&template=bug_report.yaml&name=radarr&version=0.3.0)**
...
| image.tag | string | `"5.27.0.10101"` | Image tag |
