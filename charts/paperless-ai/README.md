...
![AppVersion: 3.0.6](https://img.shields.io/badge/AppVersion-3.0.6-informational?style=flat)
...
[here](https://github.com/hydazz/charts/issues/new?assignees=hydazz&labels=bug&template=bug_report.yaml&name=paperless-ai&version=0.3.3)**
...
| image.tag | string | `"3.0.6"` | Image tag |
