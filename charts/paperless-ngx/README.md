...
[here](https://github.com/hydazz/charts/issues/new?assignees=hydazz&labels=bug&template=bug_report.yaml&name=paperless-ngx&version=0.6.0)**
...
| <https://charts.hydaz.com> | paperless-ai | 0.2.2 |
...
| image.tag | string | `"2.16.0"` | Image tag |
